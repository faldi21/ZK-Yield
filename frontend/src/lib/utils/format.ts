...
export const mockDashboardData: DashboardData = {
  ...
  positions: [
    { name: 'USDC Vault', protocol: 'Spark', network: 'Base', collateral: 'USDC', deposited: 5000, apy: 4.5, earned: 56.25 },
    { name: 'ETH Vault', protocol: 'Aave V3', network: 'Ethereum', collateral: 'ETH', deposited: 4000, apy: 3.8, earned: 38.00 },
    { name: 'LP Position', protocol: 'Uniswap V3', network: 'Arbitrum', collateral: 'ETH/USDC', deposited: 3345, apy: 12.5, earned: 104.53 },
  ],
  activities: [
