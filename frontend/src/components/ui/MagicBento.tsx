...
const ParticleCard: React.FC<{
  ...
  const animateParticles = useCallback(() => {
    ...
    memoizedParticles.current.forEach((particle, index) => {
      ...
      // Fix for type error: 'Timeout' (NodeJS) vs 'number' (browser)
      // In browser, setTimeout returns number, in NodeJS it's Timeout object.
      // We force a number for safety, compatible with clearTimeout.
